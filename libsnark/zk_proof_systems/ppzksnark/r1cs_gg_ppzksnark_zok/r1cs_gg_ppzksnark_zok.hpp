...
#include <libsnark/zk_proof_systems/ppzksnark/r1cs_gg_ppzksnark_zok/r1cs_gg_ppzksnark_zok_params.hpp>
...
class r1cs_gg_ppzksnark_zok_proving_key;
...
public:
    ...
    r1cs_gg_ppzksnark_zok_proving_key(r1cs_gg_ppzksnark_zok_proving_key<ppT> &&other) = default;
    r1cs_gg_ppzksnark_zok_proving_key(libff::G1<ppT> &&alpha_g1,
                                  libff::G1<ppT> &&beta_g1,
                                  libff::G2<ppT> &&beta_g2,
                                  libff::G1<ppT> &&delta_g1,
                                  libff::G2<ppT> &&delta_g2,
...
public:
    ...
    bool operator==(const r1cs_gg_ppzksnark_zok_verification_key<ppT> &other) const;
    friend std::ostream& operator<< <ppT>(std::ostream &out, const r1cs_gg_ppzksnark_zok_verification_key<ppT> &vk);
    friend std::istream& operator>> <ppT>(std::istream &in, r1cs_gg_ppzksnark_zok_verification_key<ppT> &vk);

    static r1cs_gg_ppzksnark_zok_verification_key<ppT> dummy_verification_key(const size_t input_size);
};
...
public:
    ...
    bool operator==(const r1cs_gg_ppzksnark_zok_processed_verification_key &other) const;
    friend std::ostream& operator<< <ppT>(std::ostream &out, const r1cs_gg_ppzksnark_zok_processed_verification_key<ppT> &pvk);
    friend std::istream& operator>> <ppT>(std::istream &in, r1cs_gg_ppzksnark_zok_processed_verification_key<ppT> &pvk);
};
 ...
 */
template<typename ppT>
class r1cs_gg_ppzksnark_zok_keypair {
public:
    r1cs_gg_ppzksnark_zok_proving_key<ppT> pk;
    r1cs_gg_ppzksnark_zok_verification_key<ppT> vk;

    r1cs_gg_ppzksnark_zok_keypair() = default;
    r1cs_gg_ppzksnark_zok_keypair(const r1cs_gg_ppzksnark_zok_keypair<ppT> &other) = default;
    r1cs_gg_ppzksnark_zok_keypair(r1cs_gg_ppzksnark_zok_proving_key<ppT> &&pk,
                              r1cs_gg_ppzksnark_zok_verification_key<ppT> &&vk) :
        pk(std::move(pk)),
        vk(std::move(vk))
    {}

    r1cs_gg_ppzksnark_zok_keypair(r1cs_gg_ppzksnark_zok_keypair<ppT> &&other) = default;
};
...
template<typename ppT>
class r1cs_gg_ppzksnark_zok_proof;
...
public:
    ...
    r1cs_gg_ppzksnark_zok_proof(libff::G1<ppT> &&g_A,
                            libff::G2<ppT> &&g_B,
                            libff::G1<ppT> &&g_C) :
        g_A(std::move(g_A)),
        g_B(std::move(g_B)),
    ...
    bool operator==(const r1cs_gg_ppzksnark_zok_proof<ppT> &other) const;
    friend std::ostream& operator<< <ppT>(std::ostream &out, const r1cs_gg_ppzksnark_zok_proof<ppT> &proof);
    friend std::istream& operator>> <ppT>(std::istream &in, r1cs_gg_ppzksnark_zok_proof<ppT> &proof);
};
 ...
 */
template<typename ppT>
r1cs_gg_ppzksnark_zok_keypair<ppT> r1cs_gg_ppzksnark_zok_generator(const r1cs_gg_ppzksnark_zok_constraint_system<ppT> &cs);
...
bool r1cs_gg_ppzksnark_zok_online_verifier_weak_IC(const r1cs_gg_ppzksnark_zok_processed_verification_key<ppT> &pvk,
                                               const r1cs_gg_ppzksnark_zok_primary_input<ppT> &input,
                                               const r1cs_gg_ppzksnark_zok_proof<ppT> &proof);
...
/**
 * For debugging purposes (of r1cs_gg_ppzksnark_zok_r1cs_gg_ppzksnark_zok_verifier_gadget):
 *
 * A verifier algorithm for the R1CS GG-ppzkSNARK that:
...
#include <libsnark/zk_proof_systems/ppzksnark/r1cs_gg_ppzksnark_zok/r1cs_gg_ppzksnark_zok.tcc>
